...
const inviteMembersToOrganization = catchAsync(async (req: Request, res: Response) => {
    ...
    const result = await InvitationService.InviteMembersToOrganization(organizationData);
    sendResponse(res, {
...
const updateInvitationStatus = catchAsync(async (req: Request, res: Response) => {
    ...
    const result = await InvitationService.updateInvitationStatus(invitationId, userId, status);
    sendResponse(res, {
        statusCode: httpStatus.OK,
        success: true,
